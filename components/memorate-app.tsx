...
export default function MemorateApp() {
  ...
  {cloudSync.status.phase === "error" && !settings && <div className="sync-warning" role="status">Cloud sync needs attention · Local notes are safe <button onClick={() => setSettings(true)}>Details</button></div>}
